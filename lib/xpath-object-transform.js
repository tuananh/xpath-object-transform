...
(function(root, factory) {
    ...
    function walk(data, path, result, key) {
        console.log('@@@WALKKKK data: %s, path: %s , result: %s, key: %s', JSON.stringify(data), JSON.stringify(path), JSON.stringify(result), JSON.stringify(key))
        var fn;
